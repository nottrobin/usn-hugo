...
description: Vasily Kulikov discovered a flaw in the Linux Kernel&#39;s perf tool
  that allows specified to be run as root. A local could exploit this flaw to run
  commands as root when using the perf tool. user could exploit this ([CVE-2013-1060](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-1060))
series:
- ubuntu-13.04
